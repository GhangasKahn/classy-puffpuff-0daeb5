...
P = {
    ...
    "furniture_pad_t": {"v": 0.75, "src": "SOURCED", "note": "McMaster 60015K58 4×4×¾″ segmented rubber pad [S]"},
    "brace_z": {"v": 18.0, "src": "ASSUMED", "note": "sujikai meets post above sill top"},
    "light_dado_w": {"v": 0.50, "src": "SOURCED", "note": "cap soffit channel for McMaster 8836N52 24V IP67 tape (½″ / 13 mm wide)"},
...
def parts(ly=None):
    ...
    civil = [
        ...
        _part(
            ...
            PURCHASE="McMaster 60015K58 — 4″ × 4″ × ¾″ segmented rubber pad",
        ...
        _part(
            PART_ID="H-006",
            PART_NAME="24V IP67 LED tape + driver (cap soffit)",
            PART_CATEGORY="H",
            ASSEMBLY="A-040 FINISH",
            QUANTITY=1,
            MAKE_OR_BUY="BUY",
            MATERIAL="low-voltage LED",
            PURCHASE="McMaster 8836N52 16′ IP67 tape + 8836N24 96W driver + wood cover slat",
            NOTES="Sits in C-001 soffit dado. Driver in a dry niche of the P3 planter — not at the house. Allowed metal: lighting only. 120 V feed is electrician work.",
            ROUGH_THICKNESS=0,
            ROUGH_WIDTH=0,
            ROUGH_LENGTH=0,
            FINISHED_THICKNESS=0,
...
def hardware():
    return [
        {
            "HARDWARE_ID": "H-001",
            "DESCRIPTION": "Segmented rubber vibration-damping pad under driveway sill",
            "STANDARD": "McMaster 60015K58",
            "SIZE": "4″ × 4″ × 0.75″",
            "QTY": 8,
            "MATERIAL": "rubber, Durometer 50A",
            "MAKE_OR_BUY": "BUY",
            "MCMASTER_PN": "60015K58",
            "MCMASTER_URL": "https://www.mcmaster.com/60015K58/",
            "ROLE": "REQUIRED",
            "EVIDENCE": "S",
        },
        {
        ...
        {
            "HARDWARE_ID": "H-003",
            "DESCRIPTION": "Optional stainless lift-off pintle set — BACKUP only. Primary hinge is mill oak W-003.",
            "STANDARD": "manufacturer — no McMaster pintle selected",
        ...
        {
            "HARDWARE_ID": "H-004",
            "DESCRIPTION": "Optional 304 SS screw-on padlockable hasp for latch bar G-010",
            "STANDARD": "McMaster 1304A42",
            "SIZE": "3¼″ Style E, No. 8 screws",
            "QTY": 1,
            "MATERIAL": "304 stainless steel, dull",
            "MAKE_OR_BUY": "BUY",
            "MCMASTER_PN": "1304A42",
            "MCMASTER_URL": "https://www.mcmaster.com/1304A42/",
            "ROLE": "OPTIONAL",
            "EVIDENCE": "S",
        },
        {
            ...
            "STANDARD": "exterior grade — paint store, not McMaster",
            "SIZE": "kit",
            "QTY": 1,
            "MATERIAL": "coating",
            "MAKE_OR_BUY": "BUY",
        ...
        {
            "HARDWARE_ID": "H-006",
            "DESCRIPTION": "24V IP67 LED tape kit in cap soffit dado (driver in P3 planter)",
            "STANDARD": "McMaster tape-light family 8836N",
            "SIZE": "16′ tape + 96 W wet-location driver",
            "QTY": 1,
            "MATERIAL": "LED + wood cover slat",
            "MAKE_OR_BUY": "BUY",
            "MCMASTER_PN": "8836N52 + 8836N24",
            "MCMASTER_URL": "https://www.mcmaster.com/products/tape-lights/",
            "ROLE": "REQUIRED",
            "EVIDENCE": "S",
        },
        {
            ...
            "STANDARD": "landscape stone — not McMaster",
    ...
    return [
        {
            ...
            "ROLE": "REQUIRED",
            "PN": "60015K58",
            "URL": "https://www.mcmaster.com/60015K58/",
            "DESCRIPTION": "Vibration-damping pad, 4″ × 4″ × ¾″, segmented, Durometer 50A, black",
            "QTY": 8,
            "UNIT": "each",
            "WHERE": "Under F-001 driveway sill — protect pavement, no fasteners into slab",
            "FAMILY": "https://www.mcmaster.com/products/vibration-damping-pads/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Same 4″ square rubber pad ≥ ½″ thick, outdoor-capable, no metal studs",
        },
        {
            "LINE": "MC-002",
            "HARDWARE_ID": "W-003",
            "ROLE": "REQUIRED",
            "PN": "96825K84",
            "URL": "https://www.mcmaster.com/96825K84/",
            "DESCRIPTION": "Red oak rod, ⌀1¼″ × 36″, dia. tol. ±0.010″ — mill two oak pivots",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "W-003: bottom socket in sill at P1, top in C-001 soffit. Cut two pins from this rod.",
            "FAMILY": "https://www.mcmaster.com/products/wood-dowel-rods/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Mill from white-oak 5/4 if rod stock is out; keep ⌀1.25″ locational fit",
        },
        {
            "LINE": "MC-003",
            "HARDWARE_ID": "W-002",
            "ROLE": "REQUIRED",
            "PN": "96825K75",
            "URL": "https://www.mcmaster.com/96825K75/",
            "DESCRIPTION": "Red oak rod, ⌀⅜″ × 36″ — drawbore pegs (prefer riven if available)",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "W-002 pegs for gate hozo + kama-tsugi. Never glue locking faces.",
            "FAMILY": "https://www.mcmaster.com/products/wood-dowel-rods/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Riven oak ⅜″ pegs from 1×4 oak on the lumber buy",
        },
        {
            "LINE": "MC-004",
            "HARDWARE_ID": "H-006A",
            "ROLE": "REQUIRED",
            "PN": "8836N52",
            "URL": "https://www.mcmaster.com/8836N52/",
            "DESCRIPTION": "IP67 wet-location LED tape, 16 ft, warm 2700 K, 24 V DC, 480 lm/ft, ½″ wide",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "C-001 soffit dado, garden edge. Cut only at marked 1″ intervals. Cover with wood slat.",
            "FAMILY": "https://www.mcmaster.com/products/tape-lights/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Same family 8836N55 (3000 K) or 8836N62 (4000 K) 16 ft IP67",
        },
        {
            "LINE": "MC-005",
            "HARDWARE_ID": "H-006B",
            "ROLE": "REQUIRED",
            "PN": "8836N24",
            "URL": "https://www.mcmaster.com/8836N24/",
            "DESCRIPTION": "24 V DC wet-location driver, 96 W, for 11–16 ft of 8836N tape, IP67 enclosure",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "Dry niche in P3 planter F-005 — never at the house. Qualified electrician for 120 V feed.",
            "FAMILY": "https://www.mcmaster.com/products/tape-lights/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "8836N25 (60 W) only if tape is shortened under 10 ft",
        },
        {
            "LINE": "MC-006",
            "HARDWARE_ID": "H-006C",
            "ROLE": "REQUIRED",
            "PN": "8836N75",
            "URL": "https://www.mcmaster.com/8836N75/",
            "DESCRIPTION": "Tape-to-wire connector, 6″ leads, for fixed white 8836N tape (not wet-rated — keep inside dado)",
            "QTY": 2,
            "UNIT": "each",
            "WHERE": "Soffit dado, under wood cover. Do not expose to rain.",
            "FAMILY": "https://www.mcmaster.com/products/tape-lights/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Solder + adhesive-lined heat-shrink inside the dado; still cover with wood",
        },
        {
            "LINE": "MC-007",
            "HARDWARE_ID": "H-006D",
            "ROLE": "OPTIONAL",
            "PN": "8836N17",
            "URL": "https://www.mcmaster.com/8836N17/",
            "DESCRIPTION": "Low aluminum tape channel, 6.6 ft, frosted lens — lighting accessory, not structure",
            "QTY": 2,
            "UNIT": "each",
            "WHERE": "Optional liner in C-001 soffit dado if the wood cover slat is omitted",
            "FAMILY": "https://www.mcmaster.com/products/tape-lights/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "Skip; default is a wood cover slat (allowed metal is lighting only)",
        },
        {
            "LINE": "MC-008",
            "HARDWARE_ID": "H-004",
            "ROLE": "OPTIONAL",
            "PN": "1304A42",
            "URL": "https://www.mcmaster.com/1304A42/",
            "DESCRIPTION": "304 SS dull screw-on padlockable hasp, Style E, 3¼″, No. 8 fasteners",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "Optional lock on G-010. Fasteners into oak latch parts only — not into nuki/posts as structure.",
            "FAMILY": "https://www.mcmaster.com/products/straight-bar-hasps/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "1304A28 (6″ Style D) if a longer throw is needed",
        },
        {
            "LINE": "MC-009",
            "HARDWARE_ID": "W-002-ALT",
            "ROLE": "OPTIONAL",
            "PN": "96825K24",
            "URL": "https://www.mcmaster.com/96825K24/",
            "DESCRIPTION": "Red oak rod, ⌀1¼″ × 48″ — longer pivot blank if 36″ rod is short after waste",
            "QTY": 1,
            "UNIT": "each",
            "WHERE": "Buy instead of MC-002 if shop wants extra length for test coupons",
            "FAMILY": "https://www.mcmaster.com/products/wood-dowel-rods/",
            "EVIDENCE": "S",
            "SUBSTITUTE": "MC-002 96825K84",
        },
    ]


def requirements():
    """WOODWRIGHT PLANFORGE requirements matrix — MUST / SHOULD / COULD / EXCLUDED."""
    return [
        {"ID": "FUN-001", "PRI": "MUST", "STATEMENT": "Freestanding 143″ run sits on the driveway slab; 100% dog containment", "VERIFY": "QC-08 aperture + QC-15 ballast + gate bottom 0.375″", "STATUS": "PROPOSED", "EVIDENCE": "G"},
        {"ID": "FUN-002", "PRI": "MUST", "STATEMENT": "Gate flush to the house at P0; no planter at the gate", "VERIFY": "layout posts[0] + F-005 only P1–P2 / P2–P3", "STATUS": "PROPOSED", "EVIDENCE": "G"},
        {"ID": "FUN-003", "PRI": "MUST", "STATEMENT": "Winter knock-down without buried hardware", "VERIFY": "AS-12 rehearsal; never glue kusabi", "STATUS": "PROPOSED", "EVIDENCE": "G"},
        {"ID": "ENV-001", "PRI": "MUST", "STATEMENT": "Buffalo 4-season: paint weather system, PT splash, end-grain sealer", "VERIFY": "H-005 schedule + K-001 PT", "STATUS": "PROPOSED", "EVIDENCE": "G"},
        {"ID": "DIM-001", "PRI": "MUST", "STATEMENT": "Envelope 143″ L × 65″ H; primary units inch; datums x=0 latch face, z=0 sill top", "VERIFY": "TBM overall_length on driveway", "STATUS": "OPEN", "EVIDENCE": "G/TBM"},
        {"ID": "LOAD-001", "PRI": "MUST", "STATEMENT": "Planning wind FS 1.5 via live planters; not PE-stamped", "VERIFY": "ballast.ratio ≥ 1.0 after planting", "STATUS": "PROPOSED", "EVIDENCE": "D"},
...
def evidence_register():
    return [
        ...
        {"ID": "EV-010", "DESC": "USDA FPL Wood Handbook moisture/movement (general)", "CLASS": "S", "RELIABILITY": "handbook", "VERIFY": "acclimate stock; do not glue cross-grain nuki"},
    ]
...
def planforge_meta():
    return {
        ...
        "RISK_TRIGGERS": [
            ...
            "wind on ~64 sf face",
            "driveway occupancy / vehicle adjacency",
            "pet containment",
            "seasonal knock-down",
        ],
        ...
        "NOT_FOR": [
            "PE stamp / code approval",
            "life-safety structure",
            "buried foundation",
            "licensed reproduction of Wright art glass",
        ],
        "CONDITIONS": [
...
def inspection():
    ...
    return [
        ...
        {"QC": "QC-17", "CHECK": "Cap soffit light dado + IP67 24V tape (8836N52); driver 8836N24 in P3 planter, not at house wall", "CLASS": "T1", "TOL": "—"},
    ]
...
def sequence():
    return [
        {"phase": "STOCK", "id": "AS-01", "title": "Procure nested lumber + PT + oak rods 96825K84/K75 + pads 60015K58 + IP67 tape 8836N52/24", "deps": [], "parts": "buy_counts"},
...
def drawing_index():
    return [
        ...
        {"DWG": "WPF-G001", "TITLE": "WOODWRIGHT PLANFORGE guidebook (G/A/J/E/F/S/Q + McMaster)", "FILE": "../planforge/index.html"},
    ]
...
def audit():
    return {
        ...
        "DRAWING_READINESS": "GOOD — G/GA/EX/P/J/T/S/QA + Planforge G/A/J/E/F/S/Q + LEGO manual; elevation paints motifs",
...
def build_project() -> dict:
    ...
    return {
        ...
        "joints": jts,
        "hardware": hw,
        "mcmaster": mcmaster_schedule(),
        "requirements": requirements(),
        "evidence": evidence_register(),
        "planforge": planforge_meta(),
